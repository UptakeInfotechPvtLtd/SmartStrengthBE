...
export const availableAccessModules = [
    ...
    { key: AccessModule.TestimonialManagement, name: 'Testimonial Management', sort_order: 7 },
    { key: AccessModule.SingleSessionManagement, name: 'Single Session Management', sort_order: 8 },
    { key: AccessModule.PackageManagement, name: 'Package Management', sort_order: 9 },
    {
        key: AccessModule.TrainWithSachinManagement,
        name: 'Train with Sachin Management',
        sort_order: 10,
    },
    { key: AccessModule.VideoManagement, name: 'Video Management', sort_order: 11 },
    { key: AccessModule.Reports, name: 'Reports', sort_order: 12 },
] as const;
